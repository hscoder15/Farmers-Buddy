...
<%if((request.getParameter("role")).equals("admin")) 
    ...
    <table width="238" valign="top" border="0" cellpadding="0" cellspacing="0">
      ...
      <td>   <form action="deletemsg.do">
      
                      <td><table width="492" border="0" align="center" bordercolor="#CD817E" bgcolor="#FAF9DE" height="386">
                        <tr>
                          <td width="7" height="57" valign="top">&nbsp;</td>
                          <td width="471"><div align="center"><span class="style11"><b>V I E W M A I L</b></span></div></td>
                          <td width="10">&nbsp;</td>
                        </tr>
                        <%
                        ...
                        MessageForm messagedto = new MessageDAO().viewMessage(messageid);
                        %>
                        <tr>
                          <td align="right">&nbsp;</td>
                          <td>
