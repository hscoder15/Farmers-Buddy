...
<body leftmargin="0" topmargin="0" bgcolor="#F8F8FF" marginheight="0" marginwidth="0">
                    ...
                    <table width="200" border="0" align="center">
                      ...
                      <tr>
                        ...
                        <%
                          ...
                          {
                         %>
                        <td bgcolor="#FFD7AE"><span class="style12"><a href="Compose.jsp?email=<%=rf1.getEmail() %>">Send message</a></span></td>
                        <%} %>
                      </tr>
                      <%} %>
                    </table>
