...
<html>
  <head>
    ...
    <title>My JSP 'updateFert.jsp' starting page</title>
 ...
 <form action="upcrop.jsp">
  <center><h3>UPDATE CROPS INFORMATION</h3></center>
  <table align="center" border=2 cellspacing=3 color="red">
   <% 
...
<tr><td><b>Soil Name</b></td><td><select name="soil_name">
