...
function sub()
{
 var search=document.register.role.value;
 location.href="ViewSearchDetails.jsp?role="+search;
...
<table>
              ...
              <TR>
                ...
                <tr>
                  ...
                  <form action="NViewSearchDetails.jsp" method="post" name="register">
                  <input type="hidden" name="loginname" value="<%=request.getParameter("loginname")%>"/>
                    <table width="200" border="0" align="center">
                      ...
                      <tr>
                        <td><table width="296" border="0" align="center" bordercolor="#CD817E" bgcolor="#c1DDD7">
                            <tr>
                              <td width="1" height="57" valign="top"></td>
                              <td width="300"><div align="center" class="style24">
                                <p class="style25">S e a r c h </p>
                                <p align="left" class="style29">Search with this criteria </p>
                              </div></td>
                              <td width="10"></td>
                            </tr>
                            <tr>
