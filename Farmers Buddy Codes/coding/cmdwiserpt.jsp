...
function sub()
{
 var state=document.cmdwiserpt.stateid.value;
 document.write(state);
 location.href="cmdwiserpt.jsp?state_id="+state;
 document.cmdwiserpt.submit();
}

function sub1()
{
 
 var mkt=document.cmdwiserpt.market.value;
 var yr=document.cmdwiserpt.year.value;
 var mon=document.cmdwiserpt.month.value;
 document.write(state);
 location.href="cmdwiserpt.jsp?market="+mkt+"&year="+yr+"&month="+mon;
}
    ...
    <table width="238" valign="top" border="0" cellpadding="0" cellspacing="0">
      ...
      <td width="700" align="center">
       <form action="cmdwiserpt.jsp" name="cmdwiserpt" method="post"> 
         <table align="center" border="1" bordercolor="pink">
         <tr><td>
             <span class="style23">State:</span><select name="stateid" onchange="sub()">
         ...
         <tr><td>
             <span class="style23">Commodity:</span><select name="cmid">  
             <option value="select">--SELECT--</option>       
             <%if(request.getParameter("state_id")!=null)
             {
                ...
                cl1=cd.getCommoditiesInState(Integer.parseInt(request.getParameter("state_id")));
                CommodityForm cf=new CommodityForm();
                Enumeration em1=cl1.elements();
                while(em1.hasMoreElements())
                {
                   System.out.println("hiiiii");
                   cf=(CommodityForm)em1.nextElement();
             %>  
         ...
         <%
             String cmd=request.getParameter("cmid");
             System.out.println("month"+cmd);
              ...
              {%>
               ...
               CommodityDAO cd=new CommodityDAO();
               cl2=md.getDetailsByCommodity(Integer.parseInt(cmd));
...
<pre>            
                                                                     <INPUT type="image" name="submit" src="./images/submit.gif" border="0"></pre>
