...
<html> 
	...
	<center><b><h4>SoilEntry Form</h4></b></center>
	
		<html:form action="/soil">
		
		
		<table cellspacing=2 align="center" bgcolor="#CEF6CE" width="325" height="60">
				<tr><td><b>SoilName</b></td><td> <html:text property="soilname" onkeypress="return lettersOnly(event)"/></td><td><html:errors property="soilname"/></td></tr>
