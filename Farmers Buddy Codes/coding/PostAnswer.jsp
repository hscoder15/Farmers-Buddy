 ...
 document.selectdistrict.submit();
  ...
  <script src="ABC/script.js" language="javascript"></script>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td bgcolor="#336600"><img src="ABC/corn-bot1.gif" width="50" height="18"><img src="ABC/sanjeev.gif" width="34" height="18"><img src="ABC/grad.gif" width="332" height="18"><jsp:include page="ngomenu.html"/></td>
      </tr>
    </tbody></table>
  ...
  <form action="ViewQueries.jsp" name="viewqueries" method="post"> 
    ...
    <table align="center">  
     <%CoreList cl=new CoreList();
       QueryForm qr=null;
       cl=new QueryDAO().getQueries(); 
       Enumeration em=cl.elements();
       while(em.hasMoreElements())
       {
         qr=(QueryForm)em.nextElement();
         System.out.println("+++++++++"+qr.getQuery());%>
                 <tr> <td><font color="blue"><%=qr.getQueryid()%>.)</font></td><td><font color="blue"><%=qr.getQuery()%></font></td><td><input type="button" value="Post Answer" onclick="javascript:location.href='ans2qry.jsp?queryid=<%=qr.getQueryid() %>'"></td></tr>
