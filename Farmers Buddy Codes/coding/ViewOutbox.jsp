    ...
    <table width="238" valign="top" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr bgcolor="green">
       ...
       <%if((request.getParameter("role")).equals("admin")) 
               ...
               <% }
               else if((request.getParameter("role")).equals("ngo")) 
                {%>
      ...
      <td width="700" align="center">
                    ...
                    <table width="472" border="0" align="center">
                  	...
                  	<p align="center" class="style27"> Sent Items </p>
                  	<form action="deletemsg.do" name="f" method="post">
                      ...
                      <tr>
                        ...
                        <td bgcolor="#FFD7AE">
                          <span class="style12"><a href="viewmail.jsp?messageid=<%=messageid%>&role=admin"><%=to%></a></span></td>
