...
function sub()
{
 var state=document.mktwisemonthly.stateid.value;
 
 document.write(state);
 location.href="mktwisemonthly.jsp?state_id="+state;
}
...
function sub1()
{
 ...
 var mkt=document.mktwisemonthly.market.value;
 var yr=document.mktwisemonthly.year.value;
 var mon=document.mktwisemonthly.month.value;
 document.write(state);
 location.href="mktwisemonthly.jsp?market="+mkt+"&year="+yr+"&month="+mon;
}
</script>
        ...
        <form action="mktwisemonthly.jsp" name="mktwisemonthly" method="post" onsubmit="sub1()"> 
         ...
         <%if(request.getParameter("state_id")!=null)
         {
          ...
          <tr><td>Year:<select name="year">
           ...
           <%
             String mkt=request.getParameter("market");
             String yr=request.getParameter("year");
		     String mon=request.getParameter("month");
		     System.out.println("state"+sid1);
		     System.out.println("market"+mkt);
             System.out.println("year"+yr);  		    
		     System.out.println("month"+mon);
		    
              if(sid1>0 && mkt!=null && yr!=null && mon!=null)
              {%>
               <table align="center" border="1" bordercolor="pink">
                  <tr>
                   <th>Market</th>
               ...
               cl2=md.getMonthlyMarket(sid1,Integer.parseInt(mkt),Integer.parseInt(yr),mon);
