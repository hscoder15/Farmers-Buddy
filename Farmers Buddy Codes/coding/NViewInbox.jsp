...
<body leftmargin="0" topmargin="0" bgcolor="#c1DDD7" marginheight="0" marginwidth="0">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td bgcolor="#336600"><img src="ABC/corn-bot1.gif" width="50" height="18"><img src="ABC/sanjeev.gif" width="34" height="18"><img src="ABC/grad.gif" width="332" height="18">
           <jsp:include page="ngomenu.html"/>
      </tr>
    </tbody></table>
    <table><tr><td>  
    <table width="238" valign="top" border="0" cellpadding="0" cellspacing="0">
      ...
      <td width="700" align="center">
					...
					<%%>
                  	<p align="center" class="style27"><u> Inbox </p>
                  	<form action="NDeleteMsgAction.do" name="f" method="post">
                  	<input type="hidden" name="page" value="NViewInbox.jsp"/>
                  	
                  	<table width="559" border="0" align="center" bordercolor="#655FE2" bgcolor="#D1C33C" style="">
                      <tr>
                      ...
                      String role="ngo";
						 ...
						 String senddate="";
                      	 ...
                      	 {
                      	      messagedto = (MessageForm)iterate.next();
                      ...
                      <tr>
                        ...
                        <td bgcolor="#FFD7AE">
                          <span class="style12"><a href="viewmail.jsp?messageid=<%=messageid%>&page=NViewInbox.jsp"><%=from%></a></span></td>
                        <td bgcolor="#FFD7AE"><span class="style12"><a href="viewmail.jsp?messageid=<%=messageid%>&page=NViewInbox.jsp">
						<%=subject%></a></span></td>
						 <td bgcolor="#FFD7AE"><span class="style12"><a href="viewmail.jsp?messageid=<%=messageid%>&page=NViewInbox.jsp"><%=senddate%></a></span></td>
                      </tr>
