...
function checkAll()
{
 ...
 for(var i=0;i<checkboxex.length;i++)
 {
  ...
  <%
      String report="";
	report+="<center><font color='brown'>Market Details</font></center><br><table><tr bgcolor='#CC3300'><td><font color='white'><b>State</b></font></td>";
		report+="<td><font color='white'><b>District</b></font></td><td><font color='white'><b>Market</b></font></td></tr>";
   ...
   <font color="white" >Export to :</font> <a href="ExportXLS" target="_blank"><font color="brown">XLS</font></a>
    ...
    <table align="center" border="1" bordercolor="green">
      ...
      <%CoreList cl=new CoreList(); 
        ...
        String st=null,dt=null,mk=null;
      ...
      <tr>
        ...
        <%
     report+="<tr bgcolor='#996666'><td><font color='white'><b>"+st+"</b></font></td>";		
		 report+="<td><font color='white'><b>"+dt +"</b></font></td><td><font color='white'><b>"+mk +"</b></font></td></tr>";
