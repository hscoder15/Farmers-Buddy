...
<html>
  <head>
    ...
    <title>My JSP 'traing.jsp' starting page</title>
  ...
  <body bgcolor="wheat">
  <form action="rtrain.do">
      <br/><br/><center><h3><u>Training Request Form</u></h3></center><br/>
  <table width=500 cellspacing=5 border=3>
  <tr><td><b>Name</b></td><td><input type="text" name="name"></td></tr>
 <tr><td><b>Role</b></td><td><select name="role">
  <option>SELECT</option>
  <option>Student</option>
  <option>Farmer</option>
  </select></td></tr>
  <tr><td><b>Place</b></td><td><input type="text" name="place"></td></tr>
   <tr><td><b>Title</b></td><td><input type="text" name="title"></td></tr>
   <tr><td><b>Description</b></td><td><input type="text" name="description"></td></tr>
    <tr><td><b>Request Schedule</b></td><td><input type="text" name="reqschedule"></td></tr>
