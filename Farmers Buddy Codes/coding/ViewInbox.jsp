    ...
    <table width="238" valign="top" border="0" cellpadding="0" cellspacing="0">
      ...
      <td width="700" align="center">
					...
					<%String role=request.getParameter("role");%>
                  	...
                  	<form action="DeleteMsgAction.do" name="f" method="post">
                      ...
                      <tr>
                        ...
                        <td bgcolor="#FFD7AE">
                          <span class="style12"><a href="viewmail.jsp?messageid=<%=messageid%>&role=admin&page=ViewInbox.jsp"><%=from%></a></span></td>
                        <td bgcolor="#FFD7AE"><span class="style12"><a href="viewmail.jsp?messageid=<%=messageid%>&role=admin">
						<%=subject%></a></span></td>
						 <td bgcolor="#FFD7AE"><span class="style12"><a href="viewmail.jsp?messageid=<%=messageid%>&role=admin"><%=senddate%></a></span></td>
                      </tr>
                      <input type="hidden" name="page" value="ViewInbox.jsp"/>
                      <%} %>
                      <tr>
