...
<script src="ABC/script.js" language="javascript"></script>
  </head><body leftmargin="0" topmargin="0" bgcolor="#F8F8FF" marginheight="0" marginwidth="0">
    ...
    <table width="814" height="409"><tr><td>  
    <table width="238" valign="top" border="0" cellpadding="0" cellspacing="0">
      ...
      <td>
      <form action="AddDistrict.do">
      <table align="center" width="400" bordercolor="#CD817E" cellspacing="2" cellpadding="2">
               <tr>
                   <td width="1" height="57" valign="top"></td>
                   <td width="300"><div align="center" class="style27"><u>Add District</u></div></td>
                   <td width="10"></td>
               </tr> 
               <tr>
                   <td align="right"></td>
                   ...
                   <tr>
                       <td><span class="style23">State:</span></td>
                           <td>
                               <label>
                   ...
                   <tr>
                       <td><span class="style23">District:</span></td>
                       <td>
                           <label>
                                  <input type="text" name="district" maxlength="20"/>         
                           </label>
                       </td>
                   </tr>
                   <tr>
                       <td><span class="style23">SoilType:</span></td>
                       <td>
                           <pre><span class="style26"><input type="checkbox" name="soil_code" value="1">Black Soil       </span><label><span class="style26"><input type="checkbox" name="soil_code" value="2">Red Soil</span></label></pre>
                           <pre><label><span class="style26"><input type="checkbox" name="soil_code" value="3">Alluvial Soil</span></label>    <label><span class="style26"><input type="checkbox" name="soil_code" value="4">Lateriate Soil</span></label></pre>
                           <pre><label><span class="style26"><input type="checkbox" name="soil_code" value="5">Mountain Soil</span></label>    <label><span class="style26"><input type="checkbox" name="soil_code" value="6">Desert Soil</span></label></pre>
