...
<script src="ABC/script.js" language="javascript"></script>
    ...
    <table align=center width="565" height="389">
    <tr align="center"><td bgcolor="#c1DDD7">
    
 
<html> 
	<head>
		<title>JSP for State_infoForm form</title>
	</head>
	<center><h3>Add State Information</h3></center>
	<body >
		<html:form action="/state">
		<table cellspacing=3  bgcolor="#66ccff">
		
			<tr><td>State:</td><td><html:text property="state"/></td><td><html:errors property="state"/></td></tr>
			<tr><td>Weather Condition:</td><td><html:textarea property="wcondition"/></td><td><html:errors property="wcondition"/><br/></td></tr>
			<tr><td><html:submit/><html:cancel/></td></tr>
		</table>
		</html:form>
	</body>
</html>
