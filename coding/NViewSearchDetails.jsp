    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td bgcolor="#336600"><img src="ABC/corn-bot1.gif" width="50" height="18"><img src="ABC/sanjeev.gif" width="34" height="18"><img src="ABC/grad.gif" width="332" height="18">
             <jsp:include page="ngomenu.html"/>      </tr>
    </tbody></table>
    <table><tr><td>  
    <table width="238" valign="top" border="0" cellpadding="0" cellspacing="0">
      ...
      <td width="700" align="center">
                    ...
                    <table width="200" border="0" align="center">
                  	...
                  	<p align="center" class="style27"><u>Batchmates</u> </p>
                  	<form action="">
                      ...
                      <tr>
                        ...
                        <td width="134" bgcolor="#FF9428"><div align="center" class="style15">Email Address</div></td>
                         ...
                         if(nm!=null)
                          {
      					 ...
      					 ArrayList al = new ProfileDAO().search(rf); 
     					 Iterator iterate = al.iterator();
     					 RegisterForm rf1 = null;
                      	 while(iterate.hasNext())
                      	 {
                      	      rf1 = (RegisterForm)iterate.next();
                      	      //name = frienddto.getLoginame(); 
                       %>
                      <tr>
                        <td bgcolor="#FFD7AE"><span class="style12"><%=rf1.getFirstName()%>&nbsp;<%=rf1.getLastName()%> </span></td>
                        <td bgcolor="#FFD7AE"><span class="style12"><%=rf1.getEmail()%></span></td>
                        
                        <%
                          if(session.getAttribute("user")!=null)
                          {
                         %>
                        <td bgcolor="#FFD7AE"><span class="style12"><a href="NCompose.jsp?email=<%=rf1.getEmail() %>">Send message</a></span></td>
                        <%} %>
                      </tr>
                      <%} %>
                    </table>
