...
<body leftmargin="0" topmargin="0" bgcolor="#F8F8FF" marginheight="0" marginwidth="0">
    ...
    <table width="238" valign="top" border="0" cellpadding="0" cellspacing="0">
      ...
      <td width="700" align="center">
        <form action="updatecommodity.do" name="updatecommodity" method="post"> 
              <%int cid=Integer.parseInt(request.getParameter("cid"));
                String cname=new CommodityDAO().getCommodityByID(cid);
                              
              %>
              <table align="center" border="1" bordercolor="pink">
                 <tr><td><input type="text" name="cname" value="<%=cname %>"></td></tr>         
