  ...
  <form action="ViewQueries.jsp" name="viewqueries" method="post"> 
   ...
   <table align="center" cellspacing="5" cellpadding="5">  
     <%CoreList cl=new CoreList();
      ...
      <center><input type="button" value="Show Answers" onclick="alert('Only authorized USERs are able to view the answers\n\t\So Please LOGIN/REGISTER')">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="Post Query" onclick="javascript:location.href='AddQuery1.jsp'"></center>
      </form>
      </body>
