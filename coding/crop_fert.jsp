...
function sub()
{
 ...
 location.href="crop_fert.jsp?state_id="+state;
 document.viewdistricts.submit();
}
</script>
	
  </head>
  <center><h3><u>Fertilizer Information</u></h3></center>
  
  <div>
      <jsp:include page="menu.html"/></div>
     <body bgcolor="#c1ddd7">
      <form action="crop_fert1.jsp" name="viewdistricts" method="post"> 
         <table align="center"  width="473" height="223">
         <tr><td bgcolor="#c6f407">
         <b>State:</b></td><td bgcolor="#7EB6FF"><select name="state_id" onchange="sub()" style="width:160px; display:block;">
         ...
         <tr>
         <td bgcolor="#c6f407"><b>District</b></td><td bgcolor="#7EB6FF"><select name="district1" style="width:160px; display:block;">
         <option>SELECT</option>
          <%
   ...
   <tr><td bgcolor="#c6f407"><b>Type</b></td><td bgcolor="#7EB6FF"><select name="cvherb" style="width:160px; display:block;">
  <option>SELECT</option>
  <option>Crop</option>
  <option>Herb</option>
  ...
  <tr><td bgcolor="#c6f407"><b>Season</b></td><td bgcolor="#7EB6FF"><select name="season" style="width:160px; display:block;">
  <option>SELECT</option>
  <option>Rabbi</option>
  ...
  <option>Kharif</option>
       ...
       <td><input type="submit" value="send"><input type="submit" value="clear"></td>
         </table>
