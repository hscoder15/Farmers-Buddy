...
function formCheck(formobj){
	...
	var fieldRequired = Array("firstname","lastname","bdate","city","state","country","email","loginname","password","squest","ownquest","sanswer");
	
	var fieldDescription = Array("First Name","Last Name","Birth Date","City","State","Country","Email","Login Name","Password","Secret Question","Own Question","Secret Answer");
	// dialog message
