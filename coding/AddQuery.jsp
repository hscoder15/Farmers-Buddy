...
function lettersOnly(evt) {
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        if(st.equalsIgnoreCase("general")){%>
        	<jsp:include page="mymenu.html"/></td>
        <%}else{ %>
        	<jsp:include page="generalmenu.html"/>
        <%} %>
      </tr>
    </tbody></table>
    <table width="983" height="409"><tr><td>  
    <table width="238" valign="top" border="0" cellpadding="0" cellspacing="0">
      ...
      <td>
		<html:form action="/postquery">
		    <table align="center" border="0" bodercolor="pink" width="687" height="164"> 
		     <tr><pre><span class="style23">Your Name:    </span><html:text property="postedby" size="20" onkeypress="lettersOnly(this)"/></pre><html:errors property="postedby"/></tr>
		    <td><span class="style23">Post Your Query:</span><html:textarea property="query"/><html:errors property="query"/><br/></td>
		     </table>
<pre>		        <html:submit/><html:cancel/></pre>
		</html:form>
	</body>
</html>
