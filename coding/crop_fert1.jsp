...
<%@page import="com.farmer.core.util.CoreList1"%>
<%@page import="com.farmer.form.FertForm"%>
...
<script src="ABC/script.js" language="javascript"></script>
    ...
    <tr align="center"><td bgcolor="#A7D39E">

<center><b><h3><u>Fertilizing Information</u></h3></b></center>
 
  <%
     int state_id3=Integer.parseInt(request.getParameter("state_id4"));
     out.println(state_id3);
    // String district=request.getParameter("district");
     
          String district1=request.getParameter("district1");
          String cvherb=request.getParameter("cvherb");
          String season=request.getParameter("season");
          
         
         
     FertDAO fda=new FertDAO();
     CoreList1 c1=fda.fert_type(state_id3,district1,cvherb,season);
     Enumeration en=c1.elements();
     
     
     
   %>
   <table border="2" cellspacing="2" aligin="center">
   <tr><td bgcolor="#c6f407"><b>Soil Name</b></td><td bgcolor="#c6f407"><b>Urea(N)</b></td><td bgcolor="#c6f407"><b>DAP(P2O5)</b></td><td bgcolor="#c6f407"><b>MOP(K)</b><br></td><td bgcolor="#c6f407"><b>Total Mixture</b></td></tr>
   <%
    
     
     while(en.hasMoreElements())
     {
       FertForm ff=(FertForm)en.nextElement();
       Float a=ff.getNitro();
       Float b=ff.getPhosporus();
       Float c=ff.getCofeecreamer();
       Float d=a+b+c;
      
      
      
       %>
       <tr><td><%=ff.getSname()%></td><td><%=ff.getNitro() %></td><td><%=ff.getPhosporus() %></td><td><%=ff.getCofeecreamer() %></td><td><%=d %></td></tr>
