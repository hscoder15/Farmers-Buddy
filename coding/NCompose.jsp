...
<script language="JavaScript" src="scripts/ts_picker.js"></script>
 ...
 <TABLE cellSpacing=0 cellPadding=0 width=775 align=center bgColor=#ffffff 
      border=0>
                ...
                <td width="462"><form action="ncompose.do" method="post" name="compose">
                  <table width="200" border="0">
                    ...
                    <tr>
                      <td><table width="481" border="0" align="center" bordercolor="#CD817E" bgcolor="#FAF9DE">
                        ...
                        RegisterForm rb = new ProfileDAO().getProfile(username);
                        %>
                        <tr>
                          <td align="right">&nbsp;</td>
                          <td>
                          <input name="loginname" type="hidden" value="<%=rb.getLoginname()%>">
                          <table width="367" height="216" border="0" align="center">
                            <tr>
                              <td width="95" height="27"><span class="style23">From</span></td>
                            ...
                            <tr>
                              ...
                              <td><span class="style37">
                                <input name="to" type="text" size="40" value="<%=request.getParameter("email")%>" readonly>
                              </span></td>
                            </tr>
                            <tr>
