...
<%@ page language="java" import="com.farmer.dao.*"%>
<%@ page language="java" import="com.farmer.form.*"%>
...
<html>
  <head>
    ...
    <title>My JSP 'upcrop.jsp' starting page</title>
  ...
  <% 
    String soil_name=request.getParameter("soil_name");
    CropDAO cd=new CropDAO();
    CoreList1 cl2=cd.crop_details(soil_name);
    Enumeration en2=cl2.elements(); 
     
  %>
  <table border=2 cellspacing=3>
  <tr>
   <td><b>Soil Name</b></td><td><b>Crop Name</b></td><td><b>Season</b></td><td><b>Commodity</b></td></tr>
 
  <%
   while(en2.hasMoreElements())
   {
     
        CropForm sif=(CropForm)en2.nextElement();
        %>
       <tr> <td><b><%=sif.getSname()%></b></td> <td><b><a href="updatecrop2.jsp?soil_name=<%=sif.getSname()%>"><%=sif.getCrop()%></a></b></td><td><b><%=sif.getSeason() %></b></td> <td><b><%=sif.getCvherb()%></b></td>
    <%  
    }
