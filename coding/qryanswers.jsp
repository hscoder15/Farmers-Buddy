...
function sub()
{
 var state=document.marketreport.stateid.value;
 document.write(state);
 location.href="AddMarketReport.jsp?state_id="+state;
 document.marketreport.submit();
}
</script>
<script language="javascript">
function sub1()
{
 var dist=document.selectdistrict.dist_id.value;
 document.write(state);
 location.href="AddMarketReport.jsp?state_id="+dist;
 document.selectdistrict.submit();
}
</script>
  <script src="ABC/script.js" language="javascript"></script>
    ...
    <table width="972" height="409"><tr><td>  
    <table width="238" valign="top" border="0" cellpadding="0" cellspacing="0">
      ...
      <form action="ViewQueries.jsp" name="viewqueries" method="post"> 
        <center><strong><font color="orange" size="12"><u>Answers</u></font></strong></center><br/><br/>
        ...
        <%CoreList cl=new CoreList();
          ...
          while(em.hasMoreElements())
          {
            ...
            <tr> <td bgcolor="#CFECEC"><span id="qns" style="font-family:Tahoma,Verdana,Arial;font-size:8pt;font-weight:bold;color:red;">Q.<%=qr.getQuery()%>&nbsp;&nbsp;<font color="#736F6E"><%=qr.getPstdate() %>&nbsp;&nbsp;<font color="#736F6E">by<%=qr.getPostedby()%></font></span></td></tr>
            <tr> <td bgcolor="#CFECEC"><span id="qns" style="font-family:Tahoma,Verdana,Arial;font-size:8pt;font-weight:bold;color:red;"><%=qr.getAnswer() %>&nbsp;&nbsp;</span></td>
        <%}%>
        </table> 
       <center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</center>
     </form>
