    ...
    <table width="238" valign="top" border="0" cellpadding="0" cellspacing="0">
      ...
      <td width="700" align="center">
					...
					<%String role=request.getParameter("role");%>
                  	...
                  	<form action="UDeleteMsgAction.do" name="f" method="post">
                  	<input type="hidden" name="page" value="UViewInbox.jsp"/>
                      ...
                      <tr>
                        ...
                        <td bgcolor="#FFD7AE">
                          <span class="style12"><a href="viewmail.jsp?messageid=<%=messageid%>&page=UViewInbox.jsp"><%=from%></a></span></td>
                        <td bgcolor="#FFD7AE"><span class="style12"><a href="viewmail.jsp?messageid=<%=messageid%>&page=UViewInbox.jsp">
						<%=subject%></a></span></td>
						 <td bgcolor="#FFD7AE"><span class="style12"><a href="viewmail.jsp?messageid=<%=messageid%>&page=UViewInbox.jsp"><%=senddate%></a></span></td>
                      </tr>
                      <%} %>
                      <tr>
