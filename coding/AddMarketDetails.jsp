...
function sub()
{
 ...
 location.href="AddMarketDetails.jsp?state_id="+state;
 document.marketdetails.submit();
  ...
  <body leftmargin="0" topmargin="0" bgcolor="#c1DDD7" marginheight="0" marginwidth="0">
    ...
    <pre>
                <table align="center">
                <form action="AddMarketDetails.jsp" name="marketdetails" method="post"> 
              ...
              <form name="selectdistrict" action="AddMarket.do" method="get">  
              <table align="center" border="1" bordercolor="pink">
              <tr align="center"><td><span class="style23">District:</span>
                   ...
                   <tr></tr>
                   <tr><td><span class="style23">Market Area:</span><input type="text" name="market"></td></tr>
