...
<html>
  <head>
    ...
    <title>My JSP 'crop_seasson1.jsp' starting page</title>
  ...
  <%
    ...
    // String district=request.getParameter("district");
          ...
          String district2=request.getParameter("district1");

          CropDAO cd=new CropDAO();
          CoreList c1=cd.crop_seasons(state_id3,district2);
          Enumeration en2=c1.elements();
   %>
   <table>
   <tr><td>State Name</td>:<td></td></tr>
   </table>
   <center>
   <table border="3" cellspacing="7" width=600>
   <tr><td bgcolor="#c6f407" colspan=3><b>Soil Name</b></td><td  bgcolor="#c6f407" colspan=3><b>Crop Name</b></td><td bgcolor="#c6f407" colspan=3><b>Season</b></td></tr>
   <%
     
     while(en2.hasMoreElements())
     {
         
       CropForm cf=(CropForm)en2.nextElement();
       
      
       %>
       <tr><td colspan=3><b><%=cf.getSname() %></td><td colspan=3><b><%=cf.getCrop() %></td><td colspan=3><b><%=cf.getSeason() %></td></tr>
