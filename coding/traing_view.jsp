...
<html>
  ...
  <%
     ...
     CoreList cl=td.View_Trainings();
     Enumeration e=cl.elements();
     
     while(e.hasMoreElements())
     {
       TrainingForm tf=(TrainingForm)e.nextElement();
       
       %>
       <tr><td><b><%=tf.getTitle()%></b></td><td><b><%=tf.getDescription() %></b></td><td><b><%=tf.getSchdule() %></b></td><td><b><%=tf.getStatus() %></b></td></tr>
    <%
     }
