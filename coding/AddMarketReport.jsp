...
.style23 {font-size: 16px; font-weight: bold; color: #CC856A; }
.style24 {
	font-size: 24px;
	font-weight: bold;
}
...
function sub1()
{
 ...
 document.selectdistrict.submit();
  ...
  <script src="ABC/script.js" language="javascript"></script>
    ...
    <table width="872" height="409"><tr><td>  
  ...
  <div>
     ...
     <form action="./storemarketdetails.jsp" name="marketreport" method="post"> 
         <table align="center" cellspacing="4" cellpadding="4">
         <tr><td><span class="style23">
         State:&nbsp;&nbsp;&nbsp;</span><select name="stateid" onchange="sub()">
		 ...
		 while(em.hasMoreElements())
		 {
		  ...
		  <%} %>
             ...
             <tr><td>
              	<span class="style23">District:</span><select name="dist_id" onchange="sub1()">  
              	<option value="select">--SELECT--</option>       
...
<pre>    <INPUT type="image" name="submit" src="./images/submit.gif" border="0"></pre>
 </form>
 </td>
 </tr>
 </table>
